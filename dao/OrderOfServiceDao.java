...
public class OrderOfServiceDao extends OrderOfService {
    ...
    public static void register(int patientRecord, int referringDoctor, int department, String typeOfservice,
            String responsibleUser, int insurance) throws SQLException {
